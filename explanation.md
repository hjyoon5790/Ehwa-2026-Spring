...
|:---:|:---:|:---:|:---:|:---|
| 1 | 이사장님 | 🔬 연구 | CyCLIP | [위성 종류가 달라도 태풍을 정확히 분류하는 AI](#team-1) |
| 2 | Sudo | 🏢 산학 | 온케어 | [사진 찍으면 영양 분석, 만성질환 맞춤 건강관리 앱](#team-2) |
| 3 | Alltology | 🔬 연구 | — | [온톨로지로 LLM 할루시네이션 줄이기 연구](#team-3) |
| 5 | 규교굥 | 🏢 산학 | Do Not Open This Box. | [AI NPC 손님과 대화하는 공포 골동품 게임](#team-5) |
| 6 | Greenfield | 🏢 산학 | Histour | [역사 인물과 AI 대화하며 한국 역사 장소 여행](#team-6) |
| 7 | reverdir | 🏢 산학 | — | [매칭·미션·투표·공개까지 마니또 활동 전 과정 앱](#team-7) |
| 8 | 하면된다 | 🏢 산학 | Vintic | [AI 가격 검증 + 정시 경매 빈티지 거래 플랫폼](#team-8) |
| 9 | Cloud9 | 🏢 산학 | Canary | [퀀트 자동매매 전략 이상 탐지 실시간 모니터링](#team-9) |
| 10 | 212223 | 🏢 산학 | — | [프롬프트 자동 최적화 + LLM API 비용 실시간 비교](#team-10) |
| 11 | 알고리듬 | 🏢 산학 | SpeedSchedule | [AI 기반 시험 감독·시프트 스케줄 자동 배정](#team-11) |
| 12 | 404 | 🏢 산학 | 여기지! | [여성 1인 여행자 안전 지도 + 동행 매칭](#team-12) |
| 13 | Semicolone; | 🏢 산학 | Flow | [AI 대화를 내 지식으로 저장·정리하는 PKM 플랫폼](#team-13) |
| 14 | def | 🔬 연구 | — | [Apple Silicon에서 AI 병목 찾고 스스로 최적화하는 에이전트](#team-14) |
| 15 | 햄부기 | 🔬 연구 | — | [Vision Transformer 경량화로 엣지 장치에서 AI 구동](#team-15) |
| 16 | 퓨터 | 🏢 산학 | — | [대화할수록 성격 바뀌는 AI 캐릭터 영어 회화 학습](#team-16) |
| 17 | SPY | 🏢 산학 | Moni | [소비 패턴 분석 + 감정형 피드백 소비 코칭 앱](#team-17) |
| 18 | 디바트 | 🔬 연구 | — | [작품 이미지 → AI 도슨트 해설 자동 생성 + 음성 변환](#team-18) |
| 19 | Logue | 🏢 산학 | Logue | [자연어로 DB 조회하는 AI 데이터 분석 인터페이스](#team-19) |
...
### Team 1 · 이사장님 — CyCLIP <a name="team-1"></a>
...
### Team 2 · Sudo — 온케어(On-Care) <a name="team-2"></a>
...
### Team 5 · 규교굥 — Do Not Open This Box. <a name="team-5"></a>
...
### Team 6 · Greenfield — Histour <a name="team-6"></a>
...
### Team 8 · 하면된다 — Vintic <a name="team-8"></a>
...
### Team 9 · Cloud9 — Canary <a name="team-9"></a>
...
### Team 11 · 알고리듬 — SpeedSchedule <a name="team-11"></a>
...
### Team 12 · 404 — 여기지! (여성 기행 지켜!) <a name="team-12"></a>
...
### Team 13 · Semicolone; — Flow <a name="team-13"></a>
...
### Team 17 · SPY — Moni <a name="team-17"></a>
